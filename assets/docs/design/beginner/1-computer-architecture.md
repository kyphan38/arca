...
- Disks can hold a lot of information, usually measured in hundreds of gigabytes (GB) or even terabytes
...
- The CPU has its own small, extra-fast memory called a cache
- It is mich smaller than RAM (measured in megabytes) but is incredibly fast
